...
DATA_PATH = "D:/samyak/as_recog_duplicate/processed_data/processed_data.pkl"
try:
...
try:
    if len(X_test) > 0:
        ...
        os.makedirs("D:/samyak/as_recog_duplicate/results", exist_ok=True)
        with open("D:/samyak/as_recog_duplicate/results/classification_report.txt", "w") as f:
            f.write(report)
        ...
        plt.ylabel('True')
        plt.savefig("D:/samyak/as_recog_duplicate/results/confusion_matrix.png")
        plt.close()
...
# Save model
MODEL_PATH = "D:/samyak/as_recog_duplicate/models/asl_model2.keras"
try:
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("D:/samyak/as_recog_duplicate/results/training_history.png")
plt.close()