...
DATA_PATH = "D:/samyak/ASL_recog_both_hands/processed_data/processed_data.pkl"
try:
...
try:
    if len(X_test) > 0:
        ...
        os.makedirs("D:/samyak/ASL_recog_both_hands/results", exist_ok=True)
        with open("D:/samyak/ASL_recog_both_hands/results/classification_report.txt", "w") as f:
            f.write(report)
        ...
        plt.ylabel('True')
        plt.savefig("D:/samyak/ASL_recog_both_hands/results/confusion_matrix.png")
        plt.close()
...
# Save model
MODEL_PATH = "D:/samyak/ASL_recog_both_hands/models/asl_model.keras"
try:
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("D:/samyak/ASL_recog_both_hands/results/training_history.png")
plt.close()