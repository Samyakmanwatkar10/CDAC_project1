...
DATA_PATH = "D:/samyak/got_it_left/processed_data/processed_data.pkl"
try:
...
try:
    if len(X_test) > 0:
        ...
        os.makedirs("D:/samyak/got_it_left/results", exist_ok=True)
        with open("D:/samyak/got_it_left/results/classification_report.txt", "w") as f:
            f.write(report)
        ...
        plt.ylabel('True')
        plt.savefig("D:/samyak/got_it_left/results/confusion_matrix.png")
        plt.close()
...
# Save model
MODEL_PATH = "D:/samyak/got_it_left/models/asl_model1.keras"
try:
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("D:/samyak/got_it_left/results/training_history.png")
plt.close()